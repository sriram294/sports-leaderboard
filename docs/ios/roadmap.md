...
| S02 | Groups and app shell | `in_progress` | `feature/ios-groups-shell` | S01 | pending | pending | 2026-08-31 | — | Transitioned from merged PR #100 at `490fecba985f48d10c6ffc72b3d2014390f28c3f`; 2026-08-31 Linux checks: repository/docs/secret and shell checks passed, all iOS Swift parsed with Swift 6.2, and the group repository/state/view-model plus unit tests passed strict-concurrency type-checking; Xcode 26.2 build/test/UI/screenshot evidence pending; leave-group contract unresolved |
