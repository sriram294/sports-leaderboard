...
| S05 | Profile, stats, settings, sharing | `in_progress` | `feature/ios-profile-stats` | S04 | pending | pending | 2026-09-02 | — | Profile/stats repositories, group-scoped Profile and Insights screens, independent partner loading, editable display name, and deterministic preview dependencies implemented; Xcode 26.2 validation remains pending |
