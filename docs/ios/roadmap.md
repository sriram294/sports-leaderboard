...
| S03 | Leaderboard | `in_progress` | `feature/ios-leaderboard` | S02 | pending | pending | 2026-08-31 | — | Transitioned from merged PR #101 at `8f106168fc08f3e9d76a0681e9b19ef5b95923da`; Linux: full Swift 6.2 parse, strict-concurrency type-check, repository/docs/shell controls, and 12/12 deterministic group + leaderboard tests passed; 2026-08-31 Codemagic Xcode 26.2 validation failed before build because `rg` was unavailable and the lock omitted Firebase's `grpc-binary` pin; 2026-09-01 repair adds a portable scanner, exact `grpc-binary` 1.69.0 pin, and truthful validation failure propagation; rerun pending |
